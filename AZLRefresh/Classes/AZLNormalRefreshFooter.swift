...
public class AZLNormalRefreshFooter: AZLRefreshFooter {
...
fileprivate extension AZLRefreshState {
    var stateText:String {
        switch self {
        case .normal:
            return AZLRefreshResourceManager.shared.localizedString(key: "AZLRefreshFooterNormalText")
        case .readyRefresh:
            return AZLRefreshResourceManager.shared.localizedString(key: "AZLRefreshFooterPullingText")
        case .refreshing:
            return AZLRefreshResourceManager.shared.localizedString(key: "AZLRefreshFooterRefreshingText")
        case .noMoreData:
